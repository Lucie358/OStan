 ...
 */
final class Version20191031130825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE user_receiver_id conversation_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE conversation_id user_receiver_id INT DEFAULT NULL');
